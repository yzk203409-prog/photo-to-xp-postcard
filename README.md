...
![标准版式参考](assets/canonical-layout.jpg)

Skill 会强制使用这张参考图的固定结构：3:4 竖版、上方实景、右下水彩写生、左下标题与恰好三枚圆形色卡。参考图采用全新虚构场景，不包含用户上传照片。
...
```text
使用 $photo-to-xp-postcard 将我上传的每张照片分别生成一张明信片研究页，严格匹配内置标准参考图的版式。
```
